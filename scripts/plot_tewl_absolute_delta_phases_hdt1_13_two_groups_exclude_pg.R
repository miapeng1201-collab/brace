...
output_absolute_plot <- file.path(tewl_dir, "TEWL_absolute_BDC_HDTE1_13_HDTM_HDTL_two_groups_exclude_PG_R.png")
output_delta_plot <- file.path(tewl_dir, "TEWL_delta_percent_BDC_HDTE1_13_HDTM_HDTL_two_groups_exclude_PG_R.png")
output_xlsx <- file.path(tewl_dir, "TEWL_absolute_delta_BDC_HDTE1_13_HDTM_HDTL_two_groups_exclude_PG_summary.xlsx")
